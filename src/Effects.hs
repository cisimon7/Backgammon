                ...
                case canMove of
                    ...
                    _     -> do
                        case (player_, whiteAllMovesDone, redAllMovesDone) of
                             (PlayerWhite, True, _) -> Game (resetAllFocus newBoard)
                                                            (resetDices newDices nextSet player_)
                                                            PlayerRed
                                                            state_
                                                            newDValues
                             (PlayerRed, _, True)   -> Game (resetAllFocus newBoard)
                                                            (resetDices newDices nextSet player_)
                                                            PlayerWhite
                                                            state_
                                                            newDValues
                             _                      -> Game (resetAllFocus newBoard) newDices player_ state_ dValues
